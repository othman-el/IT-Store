    ...
    <table class="table table-striped table-hover">
        ...
        foreach ($categories as $categorie){
            ...
            <tr>
                ...
                <td><?php echo $categorie['lebelle'] ?></td>
                <td>
                ...
                <td>
                    ...
                    <a href="supprimer_categorie.php?id=<?php echo $categorie['id'] ?>" onclick="return confirm('Voulez vous vraiment supprimer la catégorie <?php echo $categorie['lebelle'] ?>');" class="btn btn-danger">Supprimer</a>
                </td>
            </tr>
            <?php
        }
