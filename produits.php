...
<div class="container py-2">
    ...
    <table class="table table-striped table-hover">
        ...
        $categories = $pdo->query("SELECT produit.*,categorie.lebelle as 'categorie_libelle' FROM produit INNER JOIN categorie ON produit.id_categorie = categorie.id")->fetchAll(PDO::FETCH_OBJ);
        foreach ($categories as $produit){
            ...
            <tr>
                ...
                <td><img class="img-fluid" width="90" src="upload/produit/<?= $produit->image ?>" alt="<?= $produit->lebelle ?>"></td>
                <td>
