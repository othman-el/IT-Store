				...
				<div class="row">
					<div class="col-md-12">
						<div class="newsletter">
							<p>Sign Up for the <strong>NEW SLETTER</strong></p>
							<form method="post" >
							...
							<ul class="newsletter-follow">
								<li>
									<a href="https://www.facebook.com/enritechnology/"><i class="fa fa-facebook"></i></a>
								</li>
								<li>
									<a href="https://x.com/enritechnology"><i class="fa fa-twitter"></i></a>
								</li>
								<li>
									<a href="https://www.instagram.com/enriquetechnology/"><i class="fa fa-instagram"></i></a>
								</li>
								<li>
									<a href="https://www.linkedin.com/in/enrique-technology-solution-19b68b339/"><i class="fa fa-linkedin"></i></a>
								</li>
							</ul>
						</div>
					</div>
						...
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<ul class="footer-links">
									...
									<li><a href="#">Imprimante & Scanner</a></li>
									<li><a href="#">Accessoire & Périphérique</a></li>
									<li><a href="#">Logiciel & OS</a></li>
									<li><a href="#">Réseau & Serveur</a></li>
									<li><a href="#">Tablette & Téléphone</a></li>
